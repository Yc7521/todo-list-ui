<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="父事项编号" prop="parentId">
        <el-input
          v-model="queryParams.parentId"
          placeholder="请输入父事项编号"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="用户编号" prop="userId">
        <el-select v-model="queryParams.userId" placeholder="请选择用户" filterable clearable
                   :style="{width: '100%'}"
        >
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['todolist:todo:remove']"
        >删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['todolist:todo:export']"
        >导出
        </el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="todoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="父事项编号" align="center" prop="parentId"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="父事项编号" prop="parentId">
          <el-input v-model="form.parentId" placeholder="请输入父事项编号"/>
        </el-form-item>
        <el-form-item label="用户编号" prop="userId">
...
<script>
import { listTodo, getTodo, delTodo, addTodo, updateTodo } from '@/api/todolist/todo'
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除代办编号为"' + ids + '"的数据项？').then(function() {
        return delTodo(ids)
      }).then(() => {
        this.getList()
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('todolist/todo/export', {
        ...this.queryParams
